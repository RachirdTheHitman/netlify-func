...
var State;
(function(State2) {
  State2[State2["NSW"] = 0] = "NSW";
  State2[State2["QLD"] = 1] = "QLD";
  State2[State2["SA"] = 2] = "SA";
  State2[State2["TAS"] = 3] = "TAS";
  State2[State2["VIC"] = 4] = "VIC";
  State2[State2["WA"] = 5] = "WA";
  State2[State2["ACT"] = 6] = "ACT";
  State2[State2["NT"] = 7] = "NT";
})(State || (State = {}));
var ResultCode;
(function(ResultCode2) {
  ResultCode2["Y"] = "Y";
  ResultCode2["N"] = "N";
  ResultCode2["D"] = "D";
  ResultCode2["S"] = "S";
...
var handler = async (event) => {
  ...
  try {
    ...
    if (data.verificationResultCode === ResultCode.Y) {
      ...
      return {
        statusCode: 200,
        body: JSON.stringify({ kycResult: false })
      };
    } else {
      return {
        statusCode: 500,
        body: JSON.stringify(data.verificationResultCode === ResultCode.D ? {
          code: ResultCode.D,
...
//# sourceMappingURL=kyc-func.js.map
